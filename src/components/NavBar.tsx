...
export function NavBar({ intent, className }: NavBarProps) {
  return <div className={twMerge(navBar({ intent, className }))}>
    <div className="max-w-screen-xl xl:px-0 px-7 flex w-full">
      ...
      <div  className="hidden justify-center space-x-8 lg:flex ml-auto [&>*]:font-medium [&>*]:h-min [&>*]:transition-colors [&>*]:duration-500">
